...
import static com.study.auth.service.pojo.AuthCode.SUCCESS;
import static com.study.auth.service.pojo.AuthCode.USER_NOT_FOUND;

/**
 * 创建网关鉴权服务
 */
@RestController
public class AuthServiceImpl implements com.study.auth.service.AuthService {

    @Autowired
    private com.study.auth.service.impl.JwtService jwtService;
