...
//        return "login";
     ...
     * 实现票据验证功能
     *
     * @return StudyJSONResult
     */
    @PostMapping("/verifyTmpTicket")
    @ResponseBody
    public StudyJSONResult verifyTmpTicket(String tmpTicket,
                                           HttpServletRequest request,
                                           HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isBlank(tmpTicketValue)) {
            return StudyJSONResult.errorUserTicket("用户票据异常");
        }
        ...
        // 验证成功，返回OK，携带用户会话
        return StudyJSONResult.ok(JsonUtils.jsonToPojo(userRedis, UsersVO.class));
    }
    ...
    @PostMapping("/logout")
    @ResponseBody
    public StudyJSONResult logout(String userId,
                                  HttpServletRequest request,
                                  HttpServletResponse response) throws Exception {
